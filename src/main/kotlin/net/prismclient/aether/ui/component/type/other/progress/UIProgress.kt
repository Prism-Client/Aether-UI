...
import net.prismclient.aether.ui.util.interfaces.UIProgressive
 ...
 * @since 6/23/2022
 */
class UIProgress @JvmOverloads constructor(override var progress: Float = 0f, style: String?) :
    UIComponent<UIProgressSheet>(style), UIProgressive {
